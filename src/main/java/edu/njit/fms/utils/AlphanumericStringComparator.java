...
/* This class acts as comparator which sorts alphanumeric stirngs*/
public class AlphanumericStringComparator<T extends CharSequence> implements Comparator<T>{

    private T str1,str2;
    private int pos1,pos2,len1,len2;

    @Override
    public int compare(T firstString, T secondString) {
        str1=firstString;
        str2=secondString;
        len1=str1.length();
        len2=str2.length();
