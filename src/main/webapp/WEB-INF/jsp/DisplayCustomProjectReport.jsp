...
<%
  	...
  	String customsql= (request.getAttribute("customsql")).toString();
...
/* 		 String ses = (String)xeno.getArgument("session");
		 ...
		 String reportfile_final="WEB-INF/jsp/reports/"+(request.getAttribute("rptfile")).toString()+".rpt";
      ...
      String password = "telus_user_20110316";
        ...
        //if (reportSourceProject == null) {
		 ...
		 //oReportClientDocument.open(reportfile_final, 0);
     oReportClientDocument.open(getServletContext().getRealPath("/") + reportfile_final, 0);
        ...
        setDiscreteParameterValue(oFields, "CUSTOMSQL", "", CUSTOMSQL);
